...
export default function Product() {
  ...
  const handleFilter=(value,sectionId)=>{
    ...
    console.log("filter handleFilter value includes  , ",value,sectionId,filterValue);
    ...
    if(filterValue.length>0 && filterValue[0].split(",").includes(value)){
      ...
      if(filterValue.length===0)
        ...
        // console.log("filter value includes , ",value,sectionId,filterValue);
    }
    else
    { 
      console.log("filter value push includes  , ",value,sectionId,filterValue);
      filterValue.push(value);
    }
    if(filterValue.length>0){
      searchParamms.set(sectionId,filterValue.join(",")); 
      console.log("filter value join includes  , ",value,sectionId,filterValue);
    }
    const query=searchParamms.toString();
      navigate({search:`?${query}`});
  };
  const handleRadioFilterChange=(e,sectionId)=>{
    ...
    const query=searchParamms.toString();
    navigate({search:`?${query}`});
    console.log("handleRadioFilterChange value includes  , ",query);
  };
    ...
    <div className="bg-white">
      <div>
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <section className="w-full px=[3.6]">
